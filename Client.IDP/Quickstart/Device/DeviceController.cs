...
namespace IdentityServer4.Quickstart.UI.Device
{
    ...
    public class DeviceController : Controller
    {
        ...
        private DeviceAuthorizationViewModel CreateConsentViewModel(string userCode, DeviceAuthorizationInputModel model, IdentityServer4.Models.Client client, Resources resources)
        {
